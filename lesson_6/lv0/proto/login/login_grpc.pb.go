...
type LoginClient interface {
	Login(ctx context.Context, in *ReqMsg, opts ...grpc.CallOption) (*RspMsg, error)
}
...
func (c *loginClient) Login(ctx context.Context, in *ReqMsg, opts ...grpc.CallOption) (*RspMsg, error) {
	out := new(RspMsg)
...
type LoginServer interface {
	Login(context.Context, *ReqMsg) (*RspMsg, error)
...
func (UnimplementedLoginServer) Login(context.Context, *ReqMsg) (*RspMsg, error) {
...
func _Login_Login_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(LoginServer).Login(ctx, req.(*ReqMsg))
	}
